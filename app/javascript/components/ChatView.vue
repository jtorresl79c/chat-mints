    ...
    <div class="LoginPage bg-white d-flex justify-content-center align-items-center" style="height: 100vh; background-color: rgba(0, 0, 0, 0) !important;">
        ...
        <section class="msger" >
            <div class="d-flex justify-content-between">
                <button class="btn btn-primary p-2" @click="() => this.$router.push({name: 'principal'})">Principal</button>
                <button class="btn btn-danger p-2" @click="() => this.$router.push({name: 'logout'})">Logout</button>
            </div>
            <main class="msger-chat">
                ...
                <div class="msg right-msg">
                    ...
                    <div class="msg-bubble">
                        ...
                        <div class="msg-text text-primary">
